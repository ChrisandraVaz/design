export function layoutCSS(layout) {
  ...
  return `@media (min-width:1101px) {
    ${scope} .scatter-viewport { --puzzle-width:${layout.width}px; --puzzle-height:${layout.height}px; --canvas-scale:tan(atan2(min(1600px,calc(100cqw - 2 * var(--folio-gutter))),var(--puzzle-width))); }
