  ...
  return (
    <div className="container">
      ...
      <main className="main-content">
        <p className="project-meta">TD Bank (Securities) Design System</p>
        <h1 className="project-title">Tokenized Foundations</h1>
        ...
        <div className="project-info">
          ...
          <div className="info-item">
            <h4>Tools</h4>
            <p>Figma<br />Design Tokens</p>
          </div>
        </div>

        <section id="overview">
          <p className="section-label">Overview</p>
          <h2 className="section-title">A foundation that makes consistency the default.</h2>
          <p className="section-text">
            I led the development of tokenized design foundations for TD Securities&apos; internal design system, creating scalable color, typography, and spacing systems that could be maintained and reused across products.
          </p>
        </section>

        <section id="solution">
          <p className="section-label">Solution</p>
          <h2 className="section-title">Semantic tokens, theme support, and documentation teams can actually use.</h2>
          <p className="section-text">
            I created a token system with semantic naming conventions and built-in support for light and dark themes. The output included usage guidelines and documentation to help design and engineering adopt the same source of truth.
          </p>
        </section>

        <section id="outcome">
          <p className="section-label">Outcome</p>
          <h2 className="section-title">Faster design decisions and a cleaner handoff to engineering.</h2>
          <p className="section-text">
            With consistent foundations in place, teams can ship UI faster, reduce ad-hoc styling, and improve accessibility by relying on standardized, tested values.
          </p>
        </section>

        <section id="takeaways" style={{ marginBottom: 0 }}>
          <p className="section-label">Takeaways</p>
          <h2 className="section-title">Tokens are a product: naming, governance, and adoption matter.</h2>
          <p className="section-text">
            A good token system is as much about clarity and workflow as it is about values. The hardest part isn&apos;t generating tokens, it&apos;s making them easy to choose, hard to misuse, and simple to maintain.
          </p>
        </section>
