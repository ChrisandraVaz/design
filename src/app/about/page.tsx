...
export default function AboutPage(){return <main className="about-page"><header className="about-top"><Link href="/" className="about-back back-home"><span aria-hidden="true">‹</span>Back to Home</Link><CaseStudyControls /></header><div className="about-content"><section className="about-hero"><header className="about-intro"><p className="about-kicker" aria-hidden="true">About me.</p><h1><span className="sr-only">About me. </span>I&apos;m a product designer with more than 3 years of experience in a variety of domains.</h1><p>I’m driven by curiosity: complex UX problems, pushing boundaries and collaborating with creative people.</p><p>I’m a Design &amp; Business student at the University of Waterloo, where I build the design community as a Campus Leader @ Figma.</p><p>I design with purpose and I give back by mentoring and speaking at hackathons and DEI initiatives for young teens.</p></header><div className="about-content"><section className="about-hero"><header className="about-intro"><p className="about-kicker" aria-hidden="true">About me.</p><h1><span className="sr-only">About me. </span>I&apos;m a product designer with more than 3 years of experience in a variety of domains.</h1><p>I’m driven by curiosity: complex UX problems, pushed boundaries, and collaboration with creative people.</p><p>I’m a Design &amp; Business student at the University of Waterloo, where I build the design community as a Figma Campus Leader.</p><p>I design with purpose, and I give back by mentoring and speaking at hackathons and DEI initiatives for young teens.</p></header>
<div className="about-hero-pile"><p className="about-pile-label">Gotcha I see you 👀</p><p className="about-pile-hint">Pssst...You can drag the photographs</p><AboutPhotoPile photos={pilePhotos}/></div></section>
