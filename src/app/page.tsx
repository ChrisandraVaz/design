  ...
  return (
    ...
    >
      ...
      <div ref={leftPanelRef} className="portfolio-left relative w-full md:w-[45%] md:h-full flex flex-col p-6 md:p-[56px]">
        ...
        />
        <div className="absolute right-6 top-6 md:right-[56px] md:top-[56px] z-10">
        ...
        {/* Hero Text */}
        <h1 className="hero-headline text-[24px] md:text-[38px] font-normal mb-6 md:mb-[32px] text-[var(--portfolio-heading)]" style={{ lineHeight: '1.14' }}>
